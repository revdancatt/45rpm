...
const makeFeatures = () => {
  ...
  features.speed = 45 // rpm
  features.size = 7 * features.inchToCm // cm
  features.hole = 7.14375 / 10 // cm
  features.duration = 5 / 10 // minutes
  features.rotations = features.speed * features.duration // errr, rotations
  features.labelSize = 8.4 // cm
  ...
  features.gap = 1 // seconds
  features.fade = 1.5 // seconds
...
const autoDownloadCanvas = async (showHash = false) => {
  ...
  element.setAttribute('download', `45rpm_${fxhash}`)
